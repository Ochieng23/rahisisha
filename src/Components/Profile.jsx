            ...
            <div className="bg-white p-3 border-t-4 border-green-400">
              ...
              <ul className="bg-gray-100 text-gray-600 hover:text-gray-700 hover:shadow py-2 px-3 mt-3 divide-y rounded shadow-sm">
                ...
                <li className="flex items-center py-3">
                  ...
                  {user && <span className="ml-auto">{user.created_at}</span>}
                </li>
              </ul>
            </div>
            {/* <!-- End of profile card --> */}
            ...
            <div className="bg-white p-3 shadow-sm rounded-sm">
              ...
              <div className="text-gray-700">
                <div className="grid md:grid-cols-2 text-sm">
                  <div className="grid grid-cols-2">
                    ...
                    <div className="px-4 py-2">
                      ...
                      {user ? (
                        <>
                          {role === "seeker" ? (
                            <p>{user.seeker.full_name}</p>
                          ) : (
                            <p>{user.employer.full_name}</p>
                          )}
                        </>
                      ) : (
                        <p>Loading...</p>
                  ...
                  <div className="grid grid-cols-2">
                    <div className="px-4 py-2 font-semibold">Expected Pay</div>
                    <div className="px-4 py-2">{user ? (
                        <>
                          {role === "seeker" ? (
                            <p>{user.seeker.minimum_salary}</p>
                          ) : (
                            <p>{user.employer.full_name}</p>
                          )}
                        </>
                  ...
                  <div className="grid grid-cols-2">
                    ...
                    <div className="px-4 py-2">{user ? (
                        <>
                          {role === "seeker" ? (
                            <p>{user.seeker.gender}</p>
                          ) : (
                            <p>{user.employer.gender}</p>
                          )}
                        </>
                      ) : (
                        <p>Loading...</p>
                  ...
                  <div className="grid grid-cols-2">
                    ...
                    <div className="px-4 py-2">
                      ...
                      >{user ? (
                        <>
                          {role === "seeker" ? (
                            <p>{user.seeker.email}</p>
                          ) : (
                            <p>{user.employer.email}</p>
                          )}
                        </>
                      ) : (
                        <p>Loading...</p>
                  ...
                  <div className="grid grid-cols-2">
                    ...
                    <div className="px-4 py-2">{user ? (
                        <>
                          {role === "seeker" ? (
                            <p>{user.seeker.date_of_birth}</p>
                          ) : (
                            <p>{user.employer.date_of_birth}</p>
                          )}
                        </>
                      ) : (
                        <p>Loading...</p>
